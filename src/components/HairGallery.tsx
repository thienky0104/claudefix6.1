    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        <div className="mb-12 flex flex-col gap-3 md:mb-16">
          ...
          >
            Tuyển tập các kiểu tóc nam & nữ được thực hiện tại salon, từ những đường cắt tỉa tỉ mỉ, kiểu uốn tự nhiên đến những phối màu nhuộm đa chiều. Triệu Salon sẽ mang đến những kiểu tóc vượt cả mong đợi của bạn.
          </p>
        </div>
